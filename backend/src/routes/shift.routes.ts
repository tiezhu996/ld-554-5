...
shiftRoutes.post('/:id/check-in', auditMiddleware('CHECK_IN', 'shifts'), controller.checkIn);
shiftRoutes.post('/:id/check-out', auditMiddleware('CHECK_OUT', 'shifts'), controller.checkOut);
